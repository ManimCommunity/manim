...
extras_require = {"js_renderer": ["grpcio", "grpcio-tools", "watchdog"]}

entry_points = {
    "console_scripts": ["manim = manim.__main__:main", "manimce = manim.__main__:main"]
}
