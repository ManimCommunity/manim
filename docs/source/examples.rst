...
.. manim:: ManimCELogo
    ...
    class ManimCELogo(Scene):
        def construct(self):
            ...
            logo_red = "#e07a5f"
            logo_black = "#343434"
            ds_m = MathTex(r"\mathbb{M}", fill_color=logo_black, font_size=350)
    ...
    # contributed by TheoremofBeethoven, www.youtube.com/c/TheoremofBeethoven
        ...
        def construct(self):
            ...
            image = ImageMobject(np.uint8([[0, 100, 30, 200],
                                           [255, 0, 5, 33]]))
            image.height = 7
            frame_text = Text("Frame", color=PURPLE, font_size = 48 * 1.4)
            zoomed_camera_text = Text("Zoomed camera", color=RED, font_size = 48 * 1.4)
...
.. manim:: OpeningManim
    ...
    class OpeningManim(Scene):
        def construct(self):
            ...
            grid = NumberPlane()
            grid_title = Tex("This is a grid", font_size = 48 * 1.5)
