...
.. manim:: GraphAreaPlot
    ...
    class GraphAreaPlot(Scene):
        def construct(self):
            ...
            area_1 = ax.get_area_with_riemann_rectangles(curve_1, x_range=[0.3, 0.6], dx_scaling=40, color=BLUE)
            area_2 = ax.get_area(curve_2, [2, 3], bounded_graph=curve_1, color=GREY, opacity=0.5)
