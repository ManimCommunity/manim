...
A total of 107 pull requests were merged for this release.
...
* `#1249 <https://github.com/ManimCommunity/manim/pull/1249>`__: Set corners of :class:`~.Rectangle` in counterclockwise direction
   This is consistent with other geometric `Mobject`s. `Transform`ations between `Rectangle` and other geometry `Mobject`s look better now.
