...
class ManimDirective(Directive):
    ...
    def run(self):
        ...
        should_skip = "skip-manim" in self.state.document.settings.env.app.builder.tags.tags
        # Or if we are making the pot-files
        should_skip = should_skip or self.state.document.settings.env.app.builder.name=="gettext"
        if should_skip:
