...
@pytest.mark.slow
@video_comparison("SquareToCircleWithDefaultValues.json", "videos/simple_scenes/1440p60/SquareToCircle.mp4")
...
@video_comparison("SquareToCircleWithPFlag.json", "videos/simple_scenes/480p15/SquareToCircle.mp4")
