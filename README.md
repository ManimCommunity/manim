...
entry is for release `v0.8.0`, but can be adapted easily):

```
@Manual{Manim:v0.8.0,
  key =          {Manim},
  author =       {{The Manim Community Developers}},
  title =        {{Manim} -- {M}athematical {A}nimation {F}ramework ({V}ersion v0.8.0)},
...
42. The Manim Community Developers,
    [Manim – Mathematical Animation Framework (Version v0.8.0)](https://www.manim.community).
    2021.
