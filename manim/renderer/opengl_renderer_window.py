...
class Window(PygletWindow):
    ...
    def on_mouse_motion(self, x, y, dx, dy):
        ...
        self.renderer.on_mouse_motion(point, d_point)
    ...
    def on_mouse_scroll(self, x, y, x_offset: float, y_offset: float):
        ...
        self.renderer.on_mouse_scroll(point, offset)
    ...
    def on_mouse_drag(self, x, y, dx, dy, buttons, modifiers):
        ...
        point = self.renderer.pixel_coords_to_space_coords(x, y)
        d_point = self.renderer.pixel_coords_to_space_coords(dx, dy, relative=True)
        self.renderer.on_mouse_drag(point, d_point, buttons, modifiers)
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        self.renderer.on_mouse_press(point, mouse_button_map[button], modifiers)
