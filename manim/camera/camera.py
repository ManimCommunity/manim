...
LINE_JOIN_MAP = {
    LineJointType.AUTO: cairo.LineJoin.MITER,  # cairo default; TODO: this could be improved
...
CAP_STYLE_MAP = {
    CapStyleType.AUTO: cairo.LineCap.BUTT,  # cairo default; TODO: this could be improved
