...
from ...mobject.svg.opengl_tex_mobject import OpenGLMathTex, OpenGLTex
from ...mobject.types.opengl_vectorized_mobject import OpenGLVMobject
from ...utils.color import BLACK
from ...utils.space_ops import get_norm


class OpenGLBrace(OpenGLSVGPathMobject):
    ...
    def get_text(self, *text, **kwargs):
        text_mob = OpenGLTex(*text)
        self.put_at_tip(text_mob, **kwargs)
        return text_mob

    def get_tex(self, *tex, **kwargs):
        tex_mob = OpenGLMathTex(*tex)
...
class OpenGLBraceLabel(OpenGLVMobject):
    def __init__(
        self,
        obj,
        text,
        brace_direction=DOWN,
        label_constructor=OpenGLMathTex,
        label_scale=1,
        **kwargs
    ):
        ...
        if isinstance(obj, list):
            obj = OpenGLVMobject(*obj)
        self.brace = OpenGLBrace(obj, brace_direction, **kwargs)
    ...
    def shift_brace(self, obj, **kwargs):
        if isinstance(obj, list):
            obj = OpenGLVMobject(*obj)
        self.brace = OpenGLBrace(obj, self.brace_direction, **kwargs)
        self.brace.put_at_tip(self.label)
...
class OpenGLBraceText(OpenGLBraceLabel):
    def __init__(self, obj, text, label_constructor=OpenGLTex, **kwargs):
...
class OpenGLBraceBetweenPoints(OpenGLBrace):
        ...
        .. manim:: BraceBPExample
            ...
            class BraceBPExample(Scene):
                def construct(self):
                    p1 = [0,0,0]
                    p2 = [1,2,0]
                    brace = OpenGLBraceBetweenPoints(p1,p2)
    ...
    def __init__(self, point_1, point_2, direction=ORIGIN, **kwargs):
        ...
        OpenGLBrace.__init__(
            self, OpenGLLine(point_1, point_2), direction=direction, **kwargs
        )
