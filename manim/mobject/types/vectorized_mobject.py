...
class VMobject(Mobject):
    ...
    def get_subpaths_from_points(self, points: CubicBezierPath) -> list[CubicSpline]:
        """Return the given ``points`` split into subpaths: groups of
    ...
    def gen_subpaths_from_points_2d(self, points: CubicBezierPath) -> list[CubicSpline]:
        return [
            points[i:j]
    ...
    def get_subpaths(self) -> list[CubicSpline]:
        """Return the :attr:`.VMobject.points` split into subpaths: groups of
        consecutive curves where one curve's end anchor matches the next
        curve's start anchor.
    ...
    def get_subpath_split_indices_from_points(
        ...
        """Return the necessary indices to split ``points`` into subpaths:
    ...
    def get_subpath_split_indices(
        ...
        """Return the necessary indices to split :attr:`.VMobject.points` into
