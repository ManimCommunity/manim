    ...
    .. manim:: ExampleSphere
        ...
        class ExampleSphere(ThreeDScene):
            def construct(self):
                ...
                sphere1 = Sphere(center = (3,0,0),radius = 1,resolution = (30, 40),u_min = 0.001,u_max = PI - 0.001,v_min = 0,v_max = TAU)
                sphere1.set_color(RED)
                self.add(sphere1)
                sphere2 = Sphere(center=(0,1,0),radius=2,resolution=(40, 50))
                sphere2.move_to((-1,-3,0))
                sphere2.set_color(GREEN)  
                self.add(sphere2)        
                sphere3 = Sphere(center=(0,1,0),radius=2,resolution=(40, 50))     
                sphere3.move_to((-1,2,0))  
