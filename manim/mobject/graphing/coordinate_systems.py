...
class CoordinateSystem:
    ...
    def input_to_graph_coords(self, x: float, graph: ParametricFunction) -> tuple[float, float]:
    ...
    def slope_of_tangent(self, x: float, graph: ParametricFunction, **kwargs: Any) -> float:
