...
_NEWSCENEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='renderserver.NewSceneRequest.name', index=0,
...
NewSceneRequest = _reflection.GeneratedProtocolMessageType('NewSceneRequest', (_message.Message,), {
...
NewSceneResponse = _reflection.GeneratedProtocolMessageType('NewSceneResponse', (_message.Message,), {
