...
_UPDATESCENEDATAREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='scene', full_name='renderserver.UpdateSceneDataRequest.scene', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='exception', full_name='renderserver.UpdateSceneDataRequest.exception', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='has_exception', full_name='renderserver.UpdateSceneDataRequest.has_exception', index=2,
...
_SCENE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='renderserver.Scene.name', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='animations', full_name='renderserver.Scene.animations', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='background_color', full_name='renderserver.Scene.background_color', index=2,
...
UpdateSceneDataRequest = _reflection.GeneratedProtocolMessageType('UpdateSceneDataRequest', (_message.Message,), {
