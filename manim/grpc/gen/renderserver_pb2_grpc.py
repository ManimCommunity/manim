...
class RenderServer(object):
    ...
    def NewScene(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/renderserver.RenderServer/NewScene',
    ...
    def SceneFinished(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/renderserver.RenderServer/SceneFinished',
            renderserver__pb2.EmptyRequest.SerializeToString,
            renderserver__pb2.EmptyResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
