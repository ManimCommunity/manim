...
def main():
    ...
    for i, frame in enumerate(frames):
        ...
        img.save(os.path.join(output_folder, 'frame{}.png'.format(i)))
    print('Saved {} frames to {}'.format(len(frames), output_folder))


def print_usage():
    print('Manim Graphical Test Frame Extractor')
    print('This tool outputs the frames of a Graphical Unit Test '
