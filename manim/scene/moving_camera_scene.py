...
.. manim:: ChangingCameraWidthAndRestore
    ...
    class ChangingCameraWidthAndRestore(MovingCameraScene):
        def construct(self):
            ...
            self.play(self.camera.frame.animate.set_width(text.get_width() * 1.2))
            self.wait(0.3)
...
.. manim:: MovingAndZoomingCamera
    ...
    class MovingAndZoomingCamera(MovingCameraScene):
        def construct(self):
            ...
            self.add(s, t)
            self.play(self.camera.frame.animate.move_to(s).set_width(s.get_width()*2))
            self.wait(0.3)
            self.play(self.camera.frame.animate.move_to(t).set_width(t.get_width()*2))
